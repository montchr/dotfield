;;; init-tools-devdocs.el --- DevDocs.io search tool configuration -*- lexical-binding: t; -*-
;;
...
;;; Commentary:
;;
;; Configuration for documentation searches via DevDocs.io
;;
;;; Code:
...
(provide 'init-tools-devdocs)
;;; init-tools-devdocs.el ends here
