...
# SPDX-FileCopyrightText: Copyright (c) 2022-2023  John Axel Eriksson <john@insane.se>
# SPDX-License-Identifier: GPL-3.0-or-later OR MIT

## Sources:
# - <https://github.com/johnae/world/blob/272c8960da8ae0b449f538d8dfc574cd0d4c5040/users/profiles/nushell/config.nu>
...
$env.config = {
    ...
    cursor_shape: {
        emacs: blink_line # block, underscore, line, blink_block, blink_underscore, blink_line (line is the default)
...
#   }
#   cd: {
#     # e.g. cd s/o/f => cd some/other/file
#     abbreviations: true
#   }
#   history: {
