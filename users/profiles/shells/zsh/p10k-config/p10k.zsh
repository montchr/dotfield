# Generated by Powerlevel10k configuration wizard on 2022-05-07 at 03:36 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/.config/dotfield(|/*)'  DOTFIELD     '')

  typeset -g POWERLEVEL9K_DIR_DOTFIELD_VISUAL_IDENTIFIER_EXPANSION=' '
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%fwith '
