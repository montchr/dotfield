  ...
  installPhase = ''
    if test -z "$libsOnly"; then
      ( # kernel modules
        ...
        ${lib.optionalString aarch64 "cp prl_notifier/Installation/lnx/prl_notifier/prl_notifier.ko $out/lib/modules/${kernelVersion}/extra"}
      )
    fi
