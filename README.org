...
#+begin_src bash
bash -c "$(curl -LsS https://raw.githubusercontent.com/montchr/dots/feature/reshape/bootstrap)"
#+end_src

On Linux, run the following as root, reboot, and run again as the sudo user.

#+begin_src bash
bash -c "$(wget -qO - https://raw.githubusercontent.com/montchr/dots/feature/reshape/bootstrap)"
#+end_src
